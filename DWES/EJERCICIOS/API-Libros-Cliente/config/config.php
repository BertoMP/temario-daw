...
const APP_DIRECTORY         = 'http://localhost/Servidor/API-Libros-Cliente/';  // Directorio donde se encuentra la app
const APP_CALL_API          = 'http://localhost/Servidor/API-Libros-Servidor/index.php/';
