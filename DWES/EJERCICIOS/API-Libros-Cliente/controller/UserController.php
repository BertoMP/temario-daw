...
class UserController extends Controller
{
    ...
    public function login(): array
    {
        ...
        $correctedData = User::preventSQLInjection($_POST);
        ...
        $strUserRole = $this->objUserModel->getRole($correctedData['email']);

        $_SESSION['userRole'] = USER_ROLES[$strUserRole];
    ...
    public function save(): array
    {
        ...
        if (!User::checkEmptyFields($correctedData)
            and !User::checkMail($correctedData['userEmail'])) {
