...
const DEFAULT_OPTIONS       = [2, 4, 6, 8, 10, 20];                         // Options para el select de filtrado.
const APP_DIRECTORY         = 'http://localhost/Servidor/MVC-Paginacion/';  // Directorio donde se encuentra la app
