...
/***********************************************************************************************************************
 * Implementar el juego del anagrama, que consiste en que un jugador escribe una palabra y la aplicaci�n muestra       *
 * un anagrama (cambio del orden de los caracteres) generado al azar. A continuaci�n, otro jugador tiene que acertar   *
 * cu�l es el texto original. La aplicaci�n no debe permitir que el texto introducido por el jugador 1 sea la          *
 * cadena vac�a. Por ejemplo, si el jugador 1 escribe "teclado", la aplicaci�n muestra como pista un anagrama al       *
 * azar, como por ejemplo "etcloda".                                                                                   *
 ***********************************************************************************************************************/
public class Ejercicio14_JuegoAnagramas {
    /*******************************************************************************************************************
