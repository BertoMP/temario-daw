...
public class ComparadorFutbolistaEdad implements Comparator {
     ...
     * atributo edad. En caso de que la edad sea la misma, se compara en base al atributo nombre.                      *
     *                                                                                                                 *
    ...
    public int compare(Object objeto, Object otroObjeto) {
        ...
        intResultado = Integer.compare(futbolista.getIntEdad(), otroFutbolista.getIntEdad());
