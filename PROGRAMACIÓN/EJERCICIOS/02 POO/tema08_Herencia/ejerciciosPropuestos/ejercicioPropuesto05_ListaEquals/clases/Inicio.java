package tema08_Herencia.ejerciciosPropuestos.ejercicioPropuesto05_ListaEquals.clases;
...
public class Inicio {
    public static void inicio() {
        ...
        Lista otraListaAnade; //Objeto de la clase Lista.
        Lista otraListaCompara; //Objeto de la clase Lista.
        ...
        do {
            ...
            switch (intOpcionUsuario) {
                ...
                case 5 -> {
                    otraListaAnade = generaLista(scEntrada);
                    nuevaLista.anadeOtraLista(otraListaAnade);
                }
                case 6 -> {
                ...
                case 10 -> {
                    otraListaCompara = generaLista(scEntrada);
                    System.out.println(nuevaLista.equals(otraListaCompara)
                            ? "Son listas idénticas."
    ...
    private static Lista generaLista(Scanner scEntrada) {
        ...
        do {
            ...
            intValor = scEntrada.nextInt();
            listaReturn.insertarFinal(intValor);
            System.out.print("""
