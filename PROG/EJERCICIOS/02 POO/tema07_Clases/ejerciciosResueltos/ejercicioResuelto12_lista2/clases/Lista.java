package tema07_Clases.ejerciciosResueltos.ejercicioResuelto12_lista2.clases;
...
public class Lista {
    ...
    /*******************************************************************************************************************
     * Método estático encargado de fusionar dos listas en una única.                                                  *
     *                                                                                                                 *
     * @param l1 Primera lista.                                                                                        *
     * @param l2 Segunda lista.                                                                                        *
     * @return Se devuelve una lista con los valores de las dos primeras.                                              *
     *******************************************************************************************************************/
    public static Lista concatena(Lista l1, Lista l2) {
        Lista listaReturn = new Lista();

        for (int intCont = 0; intCont < l1.numeroElementos(); intCont++) {
            listaReturn.insertarFinal(l1.dimeElemento(intCont));
        }

        for (int intCont = 0; intCont < l2.numeroElementos(); intCont++) {
            listaReturn.insertarFinal(l2.dimeElemento(intCont));
        }
