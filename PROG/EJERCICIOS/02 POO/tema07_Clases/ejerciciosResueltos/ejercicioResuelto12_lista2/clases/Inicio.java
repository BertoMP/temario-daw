...
public class Inicio {
    public static void inicio() {
        ...
        Lista concatenada; //Objeto de la clase Lista que guardará la concatenación de listas.
        ...
        do {
            ...
            switch (intOpcionUsuario) {
                ...
                case 5 -> {
                    otraLista = Inicio.generaOtraLista(scEntrada);
                ...
                case 10 -> {
                    otraLista = Inicio.generaOtraLista(scEntrada);
                    concatenada = Lista.concatena(nuevaLista, otraLista);
                    concatenada.muestraLista();
                }
    ...
    private static Lista generaOtraLista(Scanner scEntrada) {
        Lista otra = new Lista();
        int intValor;
        char chrOpcionUsuario;

        do {
            System.out.print("Dime número a añadir en la nueva lista: ");
            intValor = scEntrada.nextInt();;
            otra.insertarFinal(intValor);
            scEntrada.nextLine();
