package tema09_Interfaces.ejerciciosPropuestos.ejercicioPropuesto14_ListaObjectSobrecargaSuperclaseAbstracta.clases;

import tema09_Interfaces.ejerciciosPropuestos.ejercicioPropuesto14_ListaObjectSobrecargaSuperclaseAbstracta.clases.animal.Perro;
import tema09_Interfaces.ejerciciosPropuestos.ejercicioPropuesto14_ListaObjectSobrecargaSuperclaseAbstracta.clases.animal.Persona;
...
public class Inicio {
    public static void inicio() {
        ...
        nuevaLista.insertarFinal(new Persona("Sofía", "98765432-Z", 18,
                "Administrativa"));
        nuevaLista.insertarFinal(new Persona("Julián", "02345432-S", 47, "Informático"));
        ...
        do {
            System.out.println("""
                Elige una opción:
                    ...
                    10. Ordenar elementos de forma natural (Personas y Perros por nombre).
                    11. Ordenar personas por DNI.
                    12. Ordenar personas por oficio.
                    13. Salir.""");
            ...
            switch (intOpcionUsuario) {
                    ...
                    if (nuevaLista.compruebaTipo()) {
                        nuevaLista.ordenar(new Comparator() {
                            ...
                            public int compare(Object objeto, Object otroObjeto) {
                                ...
                                return persona.getSTR_DNI().compareTo(otraPersona.getSTR_DNI());
                            }
                        });
                ...
                case 13 -> System.out.println("Finalizando programa...");
                default -> System.out.println("La opción elegida no es válida.");
            }
            System.out.println();
        } while (intOpcionUsuario != 13);
        scEntrada.close();
    }
