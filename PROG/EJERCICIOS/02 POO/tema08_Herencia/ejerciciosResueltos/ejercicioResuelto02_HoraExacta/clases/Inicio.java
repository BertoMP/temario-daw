...
public class Inicio {
    public static void inicio() {
        ...
        byte bytSegundo; //Variable que guardará los segundos del objeto.
        ...
        nuevaHoraExacta = new HoraExacta(bytHora, bytMinuto, bytSegundo);
        ...
        do {
            ...
            switch (bytOpcionUsuario) {
                ...
                case 2 -> {
                    ...
                    if (nuevaHoraExacta.setHora(bytHora)) {
                ...
                case 3 -> {
                    ...
                    if (nuevaHoraExacta.setMinutos(bytMinuto)) {
                ...
                case 4 -> {
                    bytSegundo = dimeSegundos(scEntrada);
                    if (nuevaHoraExacta.setSegundo(bytSegundo)) {
