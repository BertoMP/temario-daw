...
public class Caja {
    ...
    /*******************************************************************************************************************
     * Método encargado de devolver la unidad de medida utilizada.                                                     *
     *                                                                                                                 *
     * @return Devuelve la unidad de medida utilizada.                                                                 *
     *******************************************************************************************************************/
    ...
    public String toString() {
        return "DATOS DE LA CAJA:" +
                ...
                "\n\t-Volumen: " + (int) this.getVolumen() + (this.unidadMedida.equals(Unidad.M) ? "m3" : "cm3");
    }
}
