package tema08_Herencia.ejerciciosPropuestos.ejercicioPropuesto09_ConjuntoExtendsLista.clases;

import tema08_Herencia.ejerciciosPropuestos.ejercicioPropuesto09_ConjuntoExtendsLista.clases.lista.Conjunto;
...
public class Inicio {
    public static void inicio() {
        ...
        Conjunto otroConjunto = new Conjunto(); //Objeto de la clase Conjunto.
            ...
            switch (intOpcionUsuario) {
                ...
                case 5 -> {
                    do {
                        ...
                        intValor = scEntrada.nextInt();
                        otroConjunto.insertarFinal(intValor);
                        System.out.println("""
