package tema08_Herencia.ejerciciosPropuestos.ejercicioPropuesto07_ColaExtendsLista.clases;

import tema08_Herencia.ejerciciosPropuestos.ejercicioPropuesto07_ColaExtendsLista.clases.lista.Cola;
...
public class Inicio {
    ...
    public static void inicio() {
        ...
        for (int intCont = 0; intCont < intCantidad; intCont++) {
            cola.encola(intCont);
            System.out.println("Elemento encolado: " + intCont + " -> La cola actual es: " + cola);
        }

        System.out.println("\nDESENCOLANDO");
        for (int intCont = intCantidad;  intCont > 0; intCont--) {
            numero = cola.desencola();
