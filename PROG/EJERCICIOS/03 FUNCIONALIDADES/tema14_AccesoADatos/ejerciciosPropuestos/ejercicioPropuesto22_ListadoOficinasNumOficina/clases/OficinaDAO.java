package tema14_AccesoADatos.ejerciciosPropuestos.ejercicioPropuesto22_ListadoOficinasNumOficina.clases;
...
public class OficinaDAO {
    /*******************************************************************************************************************
     * Método encargado de realizar una búsqueda en la base de datos de todas las oficinas que tengan un número de     *
     * identificación superior al pasado por parámetro.                                                                *
     *                                                                                                                 *
     * @param intOficinaBusqueda Número de la oficina.                                                                 *
     *******************************************************************************************************************/
    public static List<Oficina> read(int intOficinaBusqueda) {
        //DECLARACIÓN DE OBJETOS
        List<Oficina> listado = null; //Listado de oficinas.
        Oficina nuevaOficina; //Oficina a insertar.
        ...
        try (Connection conexion = generaConexion()) {
            ...
            stSentenciaSql.setInt(1, intOficinaBusqueda);
            ...
            if (listado.isEmpty()) {
                System.out.println("No existen oficinas que cumplan los criterios seleccionados");
                listado = null;
            }
